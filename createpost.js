...
function createPostBody(pID, pTITLE, pURL, pDATE, pLOCAL){
	...
	var SHAREpage = '<div class="SHAREpage"><h3>Compartilhe essa página</h3><li class="item btnFacebook"><a href="http://www.facebook.com/sharer.php?u=' +pURL+ '" target="_blank">Facebook</a></li><li class="item btnTwitter"><a href="https://twitter.com/intent/tweet?text=Newsletter para o blog: o que é, os erros que cometemos e qual sua finalidadeamp;url=https://www.elainegaspareto.com/2018/11/criar-newsletter-para-o-blog.html" target="_blank" title="Compartilhe no Twitter">Twitter</a></li><li class="item btnWhatsapp"><a alt="Compartilhar no WhatsApp" data-action="share/whatsapp/share" href="whatsapp://send?text=Newsletter para o blog: o que é, os erros que cometemos e qual sua finalidade-https://www.elainegaspareto.com/2018/11/criar-newsletter-para-o-blog.html" title="Compartilhar no WhatsApp">WhatsApp</a></li></div>';
	...
	summary = '<div class="POSTcontent"><div class="POSTleft"><div class="LEFTinst"><div class="POSTdoor"><img src="'+img[0].src+'"></div><div class="TOOLSpost"><div class="ACTIONpost">' +SHAREpage+ '<div class="LIVEspot"><a class="btn LIVEtemplate" href="' +LIVEtemplate+ '" target="_blank"><i class="SEEit"></i><span>Visualizar tema</span></a></div></div></div><div class="INFORMATIONpage"><div class="DESCpost"><h3>Nossa opinião sobre o ' +pTITLE+ '</h3><p>' +DESCpost+ '</p></div>' +FEATURESthis+CHANGElog+ '</div></div></div><div class="POSTright"><div class="PURCHASEbox"><div class="PURCHASEinst"><h4><span class="LICENSEtxt">Premium</span><a target="_blank" href="#"><i class="CIRCLEhelp"></i></a><span class="PREMIUMval">' +pricePost+ '</span></h4><div class="CHECKOUTwrap"><li>Atualização do template</li><li>Nenhum script criptografado</li><li>3 Meses de suporte</li><li>Para domínios ilimitados</li><li>Remover créditos</li><span class="CHECKOUTbtn"><a href="' +CHECKOUTbtn+ '" rel="nofollow" class="btn CHECKout"><i class="CARTit"></i><span>Comprar</span></a></span></div></div></div><div class="FILEtools"><div class="ITEMdeatails"><li><strong>Atualização:</strong><i> 12/05/2020</i></li><li><strong>Criado:</strong><i> 12/05/2019</i></li><li><strong>Layout:</strong><i> Responsivo</i></li></li><li><strong>Tipo de Arquivo:</strong><i> Arquivo ZIP</i></li></div><div class="FREEdownload"><li><a class="URLfree" href="' +URLfree+ '"><div class="btn-download-left"></div><div class="btn-download-right"><span class="btn-download-right-main">Baixar Grátis</span> <span class="btn-download-right-secondary">versão de avaliação</span></div></a></li><li class="SECURITYitem">Verificado com <b>Antivírus</b></li></div></div></div></div></div></div>';
