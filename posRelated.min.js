...
function printRelatedLabels_thumbs(current){
		...
		document.write('<ul class="owl-carousel postRelated">');
		while(i<relatedTitles.length&&i<20&&i<maxresults){
			document.write('<li class="item"><a href="'+relatedUrls[r]+'"><img class="thumbRelated" src="'+thumburl[r]+'"/><p>'+relatedTitles[r]+'</p></a></li>');
			i++;
