...
function commentDisplay(json) {
  for (var i = 0; i < numcomments; i++) {
	...
	var re = /<\S[^>]*>/g; 
	document.write('<li class="slide identity' + pid + '">
<span class="imgAuthor"><img src="https://u.cubeupload.com/holasoycael/visitorGravatar35.png" width="35" height="35"/></span>
<q>');
